...
const results = {
    Sales: {
        ...
        jobInterest: '顧客の課題を引き出して最適な提案につなげられること、数字や成果が見えやすいこと、0から価値を生み出す実感を得られることが魅力です。',
        sansanGrowth: '年齢に関係なく周囲を巻き込みながら動く力が身につき、知識共有や相互称賛の文化の中で主体的に動けるようになりました。'
    },
    HR: {
        id: 'HR',
        title: '人事部',
        ...
        jobInterest: '相手の課題を探りながら最適な提案につなげられること、リアルな声を改善に生かせられること、共感する仲間を増やすことで組織成長に直接貢献できることに面白さがあります。',
        sansanGrowth: 'ロジカルさと熱量の両方を鍛えられる環境で、変化への耐性がつき、日常的に「なぜ？」を考えるようになりました。自分の意思を相手に伝えられるようにもなりました。'
    },
    Marketing: {
        id: 'Marketing',
        title: 'マーケティング部',
        ...
        jobInterest: '多様なメンバーを巻き込みながらプロジェクトを進められること、ブランドやサービスの体験設計に深く関われること、0から価値をつくること、出会いの価値を広げる仕掛けを考えられることが魅力です。',
        sansanGrowth: '経験豊富な中途メンバーの知見を借りながら、大きなイベントのオーナーを任されるなど、挑戦しながら育つ環境があります。物事を多角的に捉える力や、チーム外も巻き込みながら複雑な仕事を進める力、変化に柔軟に対応する力が身につきました。'
    },
    CS: {
        id: 'CS',
        title: 'カスタマーサクセス部（CS）',
        ...
        jobInterest: '顧客の課題を探り、改善に生かし、顧客の声と開発をつなぐ橋渡し役になれることが面白いです。既存価値を1から10へ育てていく役割にも近いです。',
    ...
    PdM: {
        ...
        jobInterest: '顧客課題の発見、ユーザーの声の活用、開発との橋渡し、プロダクトの中心での意思決定、0から1、1から10の価値創出など、非常に広い面白さがあります。',
        sansanGrowth: '大規模プロダクトにおける「作る責任」と同時に「作らない責任」も学べ、変化の速い環境で意思決定力が磨かれます。複数事業や複数業界の課題に向き合えることが特徴で、未来を信じて前進し続ける姿勢も大きな学びです。'
    },
    BX: {
        id: 'BX',
        ...
        jobInterest: 'ブランドやサービスの体験設計に深く関われること、多様なメンバーと協働できること、アイデアや表現で出会いの価値を増幅できること、既存価値をさらに強くしていけることが魅力です。',
        sansanGrowth: '「Sansanのクリエイターはビジネスに強いクリエイター」という感覚があり、ビジネス視点の解像度が高まりました。ブランディングを一度の施策ではなく、あらゆる接点で少しずつ積み重ねていくものとして捉えるようになりました。'
    },
    Legal: {
        id: 'Legal',
        title: '法務部',
        ...
        sansanRashisa: '「明日やるか」ではなく「今日やれるか」を考えるスピード感があり、現場から直接相談が来てその場で解決し、受注につながることもある。法務でありながら、セミナー登壇、PoC提案、営業、新機能モック制作まで関わるケースもあり、職域が広い。また、個人情報保護士資格の取得が必須であることも特徴のひとつです。',
        jobInterest: '法的な視点から事業やプロジェクトを支援できるだけでなく、仕組みづくりや価値創出、プロダクトや企画の意思決定にも関われる点が面白いです。法務でありながら事業を直接前に進めている実感が大きいです。',
        sansanGrowth: '「NOと言わず、どうすれば合法的に実現できるかを考える」バランス感覚が養われました。会社の成長と自分の成長が同期しており、新規事業、海外子会社対応、インシデント対応など、想像以上に幅広い経験を積める環境です。'
    },
    DataOps: {
        id: 'DataOps',
        ...
        jobInterest: '数値やデータを通じて成果を実感しやすく、運用改善が組織全体にインパクトを与えること、現場からプロダクトまで広く関われること、事業基盤を支えている実感が得られることが魅力です。',
        sansanGrowth: 'AIなど最新技術に触れながら仕事を進める力が得られ、不確実性の中でリスクを洗い出し、ヘッジしながら推進する力が身につきます。若いうちからスピード感ある意思決定を経験できることも大きな成長です。'
    },
    Design: {
        id: 'Design',
        title: 'プロダクトデザイングループ',
